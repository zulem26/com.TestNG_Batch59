...
public class Driver {
    /*
        POM de Driver icin TestBase class ina extends etmek yerine Driver class indan static
        method lar kullanarak driver olusturup, ilgili ayarlarin yapilmasi ve en sonda driver in
        kapatilmasi tercih edilmistir.

        POM de Driver class indaki getDriver() nin obje olusturularak kullanilmasini engellemek
        ...
        constructor i private yaptiginizda baska class larda Driver class indan obje olusturulmasi
        mumkun OLAMAZ
